...
const PendingApprovals = () => {
  ...
  return (
    <div className="space-y-6 pb-6">
      ...
      >
        <div className="absolute left-0 top-6 bottom-6 w-1.5 rounded-full bg-brand" />
        ...
        <div className="flex flex-wrap items-center justify-between gap-4 pl-6 relative z-10">
          <div>
            ...
            <h1 className="font-display mt-1 text-2xl font-bold text-slate-900 leading-tight">
              Pending Approvals <Clock className="inline h-6 w-6 text-brand mb-1 ml-1" />
            </h1>
          ...
          <Button variant="custom" size="none"
            onClick={() => navigate(-1)}
            className="flex items-center gap-2 rounded-2xl border border-border bg-white px-4 py-2.5 text-xs font-bold text-slate-600 shadow-sm transition hover:bg-brand-light hover:text-brand hover:border-brand/30 active:scale-95"
          >
