    ...
    <Modal isOpen={isOpen} onClose={onClose} title="Assign Task">
      <div className="space-y-4">
        ...
        <div
          ...
          className="flex cursor-pointer items-center justify-between rounded-2xl border-2 border-brand bg-brand-light p-4 transition hover:bg-[#d4f0ea]"
        >
        ...
        <div className="max-h-60 overflow-y-auto divide-y divide-border-light custom-scrollbar pr-1">
            ...
            filteredTeammates.map((teammate) => {
              ...
              return (
                <div
                  ...
                  className="flex items-center justify-between py-3 px-2 rounded-xl hover:bg-surface-card cursor-pointer transition"
                >
                  <div className="flex items-center gap-3">
                    <div className="flex h-9 w-9 items-center justify-center rounded-full bg-warm text-sm font-semibold text-white">
                  ...
                  {isSelected ? (
                    ...
                    <UserPlus className="h-4 w-4 text-slate-400 hover:text-brand" />
                  )}
                </div>
              );
            })
